...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // ***************************************************
        File date_dir = new File(newDirectory, "Date_Wise");
        if (!date_dir.exists()) {
            if (date_dir.mkdir()) {
                System.out.println("date_wise directory created inside StationLogFiles");
            } else {
                System.out.println("date_wise to create Solar directory.");
                return;
            }
        }
        // ***************************************************
        ...
        File date_file = new File(date_dir, today_date_name);

        try {
            if (date_file.createNewFile()) {
                System.out.println("Datewise Log files created");
            }

        } catch (IOException e) {
            System.out.println("Error Occured in creating Datewise Log files");
            e.printStackTrace();
        }

        // --------------------------------------
        File solarDirectory = new File(newDirectory, "Solar");
        if (!solarDirectory.exists()) {
            if (solarDirectory.mkdir()) {
                System.out.println("Solar directory created inside StationLogFiles");
            } else {
                System.out.println("Failed to create Solar directory.");
                return;
            }
        }
        // --------------------------------------
        File windDirectory = new File(newDirectory, "Wind");
        if (!windDirectory.exists()) {
            if (windDirectory.mkdir()) {
                System.out.println("Wind directory created inside StationLogFiles");
            } else {
                System.out.println("Failed to create Wind directory.");
                return;
            }
        }
        // ---------------------------------------
        File gridDirectory = new File(newDirectory, "Grid");
        if (!gridDirectory.exists()) {
            if (gridDirectory.mkdir()) {
                System.out.println("Grid directory created inside StationLogFiles");
            } else {
                System.out.println("Failed to create Grid directory.");
                return;
            }
        }
        // ---------------------------------------
        ...
        // ===============================================================
        File solarfile = new File(solarDirectory, "Solar_E_Sourse_Logfile");
        try {
            if (solarfile.createNewFile()) {
                System.out.println("Solar files created");
            }

        } catch (IOException e) {
            System.out.println("Error Occured in creating Solar Log files");
            e.printStackTrace();
        }
        // =================================================================
        File windfile = new File(windDirectory, "Wind_E_Sourse_Logfile");
        try {
            if (windfile.createNewFile()) {
                System.out.println("Wind Log files created");
            }

        } catch (IOException e) {
            System.out.println("Error Occured in creating Wind files");
            e.printStackTrace();
        }
        // ================================================================
        File gridfile = new File(gridDirectory, "Grid_E_Sourse_Logfile");
        try {
            if (gridfile.createNewFile()) {
                System.out.println("Grid Log files created");
            }

        } catch (IOException e) {
            System.out.println("Error Occured in creating Grid Log files");
            e.printStackTrace();
        } // ===============================================================
